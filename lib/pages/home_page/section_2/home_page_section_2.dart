...
import 'package:medico_lavoro/pages/home_page/section_2/widgets/s2_accordion.dart';
import 'package:medico_lavoro/pages/home_page/section_2/widgets/s2_title_desc.dart';
...
class HomePageSection2 extends StatelessWidget {
  ...
  Widget _mobileView(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(
          horizontal: ResponsiveBreakpoints.of(context).isMobile ? 30.0 : 0.0),
      child: Column(
